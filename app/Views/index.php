...
<body>
                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <li><a href="index.html#">Pages <i class="fas fa-angle-down"></i></a>
                                        <ul class="submenu">
                        ...
                        <div class="nav-button">
                            ...
                            <nav>
                                ...
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-link active" id="nav-one-tab" data-bs-toggle="tab" href="index.html#nav-one" role="tab" aria-controls="nav-one" aria-selected="true">Men</a>
                                    <a class="nav-link" id="nav-two-tab" data-bs-toggle="tab" href="index.html#nav-two" role="tab" aria-controls="nav-two" aria-selected="false">Women</a>
                                    <a class="nav-link" id="nav-three-tab" data-bs-toggle="tab" href="index.html#nav-three" role="tab" aria-controls="nav-three" aria-selected="false">Baby</a>
                                    <a class="nav-link" id="nav-four-tab" data-bs-toggle="tab" href="index.html#nav-four" role="tab" aria-controls="nav-four" aria-selected="false">Fashion</a>
                                </div>
                            </nav>
                    ...
                    <div class="tab-pane fade show active" id="nav-one" role="tabpanel" aria-labelledby="nav-one-tab">
                        ...
                        <div class="latest-items-active">
                            ...
                            <div class="properties pb-30">
                                <div class="properties-card">
                                    <div class="properties-img">
                                        <a href="pro-details.html"><img src="assets/user/img/gallery/latest1.jpg" alt></a>
                            ...
                            <div class="properties pb-30">
                                <div class="properties-card">
                                    <div class="properties-img">
                                        <a href="pro-details.html"><img src="assets/user/img/gallery/latest2.jpg" alt></a>
                                        <div class="socal_icon">
                                            <a href="index.html#"><i class="ti-shopping-cart"></i></a>
                                            <a href="index.html#"><i class="ti-heart"></i></a>
                                            <a href="index.html#"><i class="ti-zoom-in"></i></a>
                            ...
                            <div class="properties pb-30">
                                <div class="properties-card">
                                    <div class="properties-img">
                                        <a href="pro-details.html"><img src="assets/user/img/gallery/latest3.jpg" alt></a>
                                        <div class="socal_icon">
                                            <a href="index.html#"><i class="ti-shopping-cart"></i></a>
                                            <a href="index.html#"><i class="ti-heart"></i></a>
                                            <a href="index.html#"><i class="ti-zoom-in"></i></a>
                            ...
                            <div class="properties pb-30">
                                <div class="properties-card">
                                    <div class="properties-img">
                                        <a href="pro-details.html"><img src="assets/user/img/gallery/latest4.jpg" alt></a>
                                        <div class="socal_icon">
                                            <a href="index.html#"><i class="ti-shopping-cart"></i></a>
                                            <a href="index.html#"><i class="ti-heart"></i></a>
                                            <a href="index.html#"><i class="ti-zoom-in"></i></a>
            ...
            <div class="container">
                <div class="latest-items-active">
                    ...
                    <div class="properties pb-30">
                        <div class="properties-card">
                            <div class="properties-img">
                                <a href="pro-details.html"><img src="assets/user/img/gallery/latest5.jpg" alt></a>
                                <div class="socal_icon">
                                    <a href="index.html#"><i class="ti-shopping-cart"></i></a>
                                    <a href="index.html#"><i class="ti-heart"></i></a>
                                    <a href="index.html#"><i class="ti-zoom-in"></i></a>
                    ...
                    <div class="properties pb-30">
                        <div class="properties-card">
                            <div class="properties-img">
                                <a href="pro-details.html"><img src="assets/user/img/gallery/latest6.jpg" alt></a>
                                <div class="socal_icon">
                                    <a href="index.html#"><i class="ti-shopping-cart"></i></a>
                                    <a href="index.html#"><i class="ti-heart"></i></a>
                                    <a href="index.html#"><i class="ti-zoom-in"></i></a>
                    ...
                    <div class="properties pb-30">
                        <div class="properties-card">
                            <div class="properties-img">
                                <a href="pro-details.html"><img src="assets/user/img/gallery/latest7.jpg" alt></a>
                                <div class="socal_icon">
                                    <a href="index.html#"><i class="ti-shopping-cart"></i></a>
                                    <a href="index.html#"><i class="ti-heart"></i></a>
                                    <a href="index.html#"><i class="ti-zoom-in"></i></a>
                    ...
                    <div class="properties pb-30">
                        <div class="properties-card">
                            <div class="properties-img">
                                <a href="pro-details.html"><img src="assets/user/img/gallery/latest8.jpg" alt></a>
                                <div class="socal_icon">
                                    <a href="index.html#"><i class="ti-shopping-cart"></i></a>
                                    <a href="index.html#"><i class="ti-heart"></i></a>
                                    <a href="index.html#"><i class="ti-zoom-in"></i></a>
    ...
    <script src="assets/user/js/vendor/modernizr-3.5.0.min.js"></script>
    ...
    <script src="assets/user/js/jquery.slicknav.min.js"></script>
    ...
    <script src="assets/user/js/price_rangs.js"></script>

    <script src="assets/user/js/contact.js"></script>
    <script src="assets/user/js/jquery.form.js"></script>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317" integrity="sha512-euoFGowhlaLqXsPWQ48qSkBSCFs3DPRyiwVu3FjR96cMPx+Fr+gpWRhIafcHwqwCqWS42RZhIudOvEI+Ckf6MA==" data-cf-beacon='{"rayId":"84cfc04cfcb23e2f","b":1,"version":"2024.1.0","token":"cd0b4b3a733644fc843ef0b185f98241"}' crossorigin="anonymous"></script>
</body>
